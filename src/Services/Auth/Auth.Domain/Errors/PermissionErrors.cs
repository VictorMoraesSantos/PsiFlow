...
namespace Auth.Domain.Errors
{
    public static class PermissionErrors
    {
        ...
        public static Error NotFound(string claimValue) => Error.NotFound($"Permission '{claimValue}' was not found.");
        public static Error Duplicate(string claimValue) => Error.Failure($"Permission '{claimValue}' already exists.");
    }
}
