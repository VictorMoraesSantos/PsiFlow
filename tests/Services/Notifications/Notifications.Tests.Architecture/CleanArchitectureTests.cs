...
public sealed class CleanArchitectureTests
{
    ...
    {
        var asm = typeof(global::Notifications.Domain.Entities.NotificationTemplate).Assembly;
    ...
    {
        var asm = typeof(Infrastructure.Persistence.Data.NotificationsDbContext).Assembly;
        var result = Types.InAssembly(asm)
